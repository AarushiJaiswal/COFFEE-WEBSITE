...
const ServicesData = [
  {
    ...
    name: "Americano",
    description:
      "Indulge in the classic Americano experience with a rich espresso shot.",
    aosDelay: "100",
  },
  {
    id: 2,
    ...
    name: "Espresso",
    description:
      "Indulge in the rich flavor of espresso crafted through ground beans.",
    aosDelay: "300",
  },
  {
    id: 3,
    img: Img2,
    name: "Cappuccino",
    description: "Indulge in the rich and velvety taste of our Cappuccino.",
    aosDelay: "500",
  },
];
