          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              className="text-sm text-gray-500 tracking-wide leading-5">
                Our premium blend coffee is crafted from a curated selection of
                the finest beans sourced globally. Each sip offers a balance of
                bold flavors, ensuring a truly exceptional experience.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-5 ">
                  ...
                  data-aos-delay="500"
                  className="flex items-center gap-3">
                    <BiCoffeeTogo className="text-2xl h-12 w-12 shadow-sm p-3 rounded-full bg-red-100" />
